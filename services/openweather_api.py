...
from common.functions import convert_temp, convert_speed
...
def get_weather():
    ...
    try:
        ...
        weather = {
            "nazwa": data.get("name"),
            "temperatura": convert_temp( data.get("main").get("temp") ),
            "odczuwalna": convert_temp( data.get("main").get("feels_like") ),
